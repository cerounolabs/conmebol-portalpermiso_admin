                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="col-10 card-title">Cargos</h4>
								</div>
                                    ...
                                    <table id="tableLoad" class="table v-middle" style="width: 100%;">
                                        <thead id="tableCodigo" class="">
                                            <tr class="bg-conmebol" style="text-align:center;">
                                                ...
                                                <th class="border-top-0">PUESTO CANTIDAD</th>
                                                <th class="border-top-0">PUESTO OCUPADO</th>
                                                <th class="border-top-0">PUESTO VACANTE</th>
