                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Inasistencia</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="col-10 card-title">Inasistencia</h4>
								</div>
                                    ...
                                    <table id="tableLoad" class="table v-middle" style="width: 100%;">
                                        <thead id="tableCodigo" class="">
                                            <tr class="bg-conmebol" style="text-align:center;">
                                                ...
                                                <th class="border-top-0">UNIDAD</th>
                                                <th class="border-top-0">IDENTIDAD</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
?>
    ...
    <script src="../js/inasistencia.js?<?php echo date('Ymd');?>"></script>
</body>
</html>