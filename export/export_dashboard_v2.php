<?php
    ...
    $sheetXLS->setActiveSheetIndex(0)
        ...
        ->setCellValue('C1', 'tipo_estado_castellano')
        ->setCellValue('D1', 'tipo_comprobante_codigo')
        ->setCellValue('E1', 'tipo_comprobante_castellano')
        ->setCellValue('F1', 'comprobante_periodo') 
        ->setCellValue('G1', 'tipo_mes_codigo') 
        ->setCellValue('H1', 'tipo_mes_castellano') 
                        ...
                        if ($parm07 == 0) {
                            if ($parm08 == 0) {
                                $sheetXLS->setActiveSheetIndex(0)
                                    ...
                                    ->setCellValue('C'.$indexRow, $valueJSON['tipo_estado_castellano'])
                                    ->setCellValue('D'.$indexRow, $valueJSON['tipo_comprobante_codigo'])
                                    ->setCellValue('E'.$indexRow, $valueJSON['tipo_comprobante_castellano'])
                                    ->setCellValue('F'.$indexRow, $valueJSON['comprobante_periodo'])
                                    ->setCellValue('G'.$indexRow, $valueJSON['tipo_mes_codigo'])
                                    ->setCellValue('H'.$indexRow, $valueJSON['tipo_mes_castellano'])
